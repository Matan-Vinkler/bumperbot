...
class SimpleTurtlesimKinematics(Node):
    ...
    def turtle1PoseCallback(self, msg):
        self.last_turtle1_pose_: Pose = msg

    def turtle2PoseCallback(self, msg):
        self.last_turtle2_pose_: Pose = msg
        ...
        self.get_logger().info(f"""\n
                               Translation Vector (turtle1 -> turtle2): [Tx, Ty] = [{Tx}, {Ty}] \n
                               Rotation Matrix (turtle1 -> turtle2): theta = {theta_rad} rad, {theta_deg}* \n
