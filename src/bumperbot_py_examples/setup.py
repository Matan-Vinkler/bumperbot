...
setup(
    ...
    zip_safe=True,
    maintainer='matan',
    maintainer_email='matanvinkler@gmail.com',
    ...
    entry_points={
        'console_scripts': [
            ...
            'simple_lifecycle = bumperbot_py_examples.simple_lifecycle:main',
            'simple_qos_pub = bumperbot_py_examples.simple_qos_pub:main',
            'simple_qos_sub = bumperbot_py_examples.simple_qos_sub:main',
        ],
    },
)
